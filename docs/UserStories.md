...
- Operation Plans are generated by the Planning & Scheduling module, using the selected algorithm: o An Operation Plan aggregates all the (sequence of) operations related to a VVN. o Each plan must include, among others, the assigned resources, planned time windows for loading/unloading.
